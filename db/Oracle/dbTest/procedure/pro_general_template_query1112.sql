create or replace procedure pro_general_template_query1112 --通用模板查询
( -- 以下为参数声明部分
   ...
   NEAndTimeFilterSQLStr in varchar2, -- 网元和时间的组合脚本 added by 叶刚
   NEAndTimeFilterSQLStr1 in varchar2, -- 网元和时间的组合脚本 added by 叶刚
